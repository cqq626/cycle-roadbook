export const coordConvert = (function () {
  ...
  function baidu09ToWGS84(bd09latlng) {
    const gcj02Latlng = baiduTomars(bd09latlng);
    const wgs84Latlng = transformGCJ2WGS(gcj02Latlng);
    return wgs84Latlng;
  }
